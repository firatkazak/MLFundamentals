...
df = pd.read_csv(filepath_or_buffer="C:/Users/firat/OneDrive/Belgeler/Projects/MLFundamentals/Libraries/spaCy/Data/Inputs/stocks.tsv", sep='\t')
...
df2 = pd.read_csv(filepath_or_buffer="C:/Users/firat/OneDrive/Belgeler/Projects/MLFundamentals/Libraries/spaCy/Data/Inputs/indexes.tsv", sep="\t")

indexes = df2.IndexName.tolist()
index_symbols = df2.IndexSymbol.tolist()

df3 = pd.read_csv(filepath_or_buffer="C:/Users/firat/OneDrive/Belgeler/Projects/MLFundamentals/Libraries/spaCy/Data/Inputs/stock_exchanges.tsv", sep="\t")
