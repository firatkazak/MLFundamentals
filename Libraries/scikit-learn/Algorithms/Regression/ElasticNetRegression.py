...
# Elastic Net regression modeli oluşturma
model = ElasticNet(alpha=0.1, l1_ratio=0.5)
# ElasticNet modelini oluşturuyoruz;
# alpha, düzenleme gücünü kontrol eder, l1_ratio ise L1 (Lasso) ve L2 (Ridge) düzenlemesi arasındaki oranı belirler.
# l1_ratio=0.5, L1 ve L2 düzenlemesinin eşit katkı sağlaması anlamına gelir.
...
ax.set_title('Elastic Net Regression')  # Grafiğin başlığını belirtiyoruz.

plt.legend()  # Grafikteki etiketler için bir efsane (legend) oluşturuyoruz.
plt.show()  # Grafiği gösteriyoruz.

# Elastic Net Regression
# Hem Lasso (L1) hem de Ridge (L2) düzenlemeyi birleştirir.
